...
DIAS_SEMANA_MAP = {"Monday": "Segunda-feira", "Tuesday": "Terça-feira", "Wednesday": "Quarta-feira", "Thursday": "Quinta-feira", "Friday": "Sexta-feira", "Saturday": "Sábado", "Sunday": "Domingo"}
...
if app_mode == "Dashboard de Pendências":
    ...
    if page == "Enviar Pagamentos":
        ...
        if df_para_envio_montagem is not None and not df_para_envio_montagem.empty:
            ...
            df['status_envio'] = df['identificador_boletim_montagem'].apply(lambda x: "Já enviado" if x in sent_boletins else "Pendente")
